...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFjaWVqd2UiLCJhIjoiY2t6ZWplcWgxMGh0MjJwcGpneHVvNnJ2diJ9.qSmTb0ojFs0Uy_z6fpQNmQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1).toLowerCase(), " updated successfully"));
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KVYXdHWNkn4F6uG0kXYDsCQmWieXtoBGd9roczXQXcbYPhkmKe5W6HYIDBUAIM8cr0KsC9eoQIxYPqzV143eBWk00GFM8Lt9p');
            _context.next = 4;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            if (document.getElementById('photo').files[0]) {
              ...
              document.getElementById('user-photo').src = "img/users/".concat(updatedPhoto);
            }
